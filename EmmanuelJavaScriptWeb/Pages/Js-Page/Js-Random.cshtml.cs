...
{
    public class Js_RandomModel : PageModel
    {
        private readonly ApplicationDbContext dbContext;
        private readonly SignInManager<ApplicationUser> signInManager;

        //public Tracker Tracker { get; set; }
        public Js_RandomModel(ApplicationDbContext dbContext, SignInManager<ApplicationUser> signInManager)
        {
        ...
        public void OnGet()
        {
            if (signInManager.IsSignedIn(User))
            {
                ...
                if (getdata != null)
                {
                    getdata.WebUrl = "/Js-Page/Js-Random";
                }
                else
                {
                    Tracker tr = new()
                    {
                        WebUrl = "/Js-Page/Js-Random",
                        AppId = claim.Value
                    };
                    dbContext.Add(tr);
                }
