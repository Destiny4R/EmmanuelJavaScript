...
{
    public class Js_ConstModel : PageModel
    {
        private readonly ApplicationDbContext dbContext;
        private readonly SignInManager<ApplicationUser> signInManager;

        //public Tracker Tracker { get; set; }
        public Js_ConstModel(ApplicationDbContext dbContext, SignInManager<ApplicationUser> signInManager)
        {
        ...
        public void OnGet()
        {
            if (signInManager.IsSignedIn(User))
            {
                ...
                if (getdata != null)
                {
                    getdata.WebUrl = "/Js-Page/Js-Const";
                }
                else
                {
                    Tracker tr = new()
                    {
                        WebUrl = "/Js-Page/Js-Const",
                        AppId = claim.Value
                    };
                    dbContext.Add(tr);
                }
