...
{
    public class Js_SwitchModel : PageModel
    {
        private readonly ApplicationDbContext dbContext;
        private readonly SignInManager<ApplicationUser> signInManager;

        //public Tracker Tracker { get; set; }
        public Js_SwitchModel(ApplicationDbContext dbContext, SignInManager<ApplicationUser> signInManager)
        {
        ...
        public void OnGet()
        {
            if (signInManager.IsSignedIn(User))
            {
                ...
                if (getdata != null)
                {
                    getdata.WebUrl = "/Js-Page/JS-Switch";
                }
                else
                {
                    Tracker tr = new()
                    {
                        WebUrl = "/Js-Page/JS-Switch",
                        AppId = claim.Value
                    };
                    dbContext.Add(tr);
                }
