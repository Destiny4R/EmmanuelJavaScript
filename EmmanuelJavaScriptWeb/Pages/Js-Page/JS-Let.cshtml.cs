...
{
    public class JS_LetModel : PageModel
    {
        private readonly ApplicationDbContext dbContext;
        private readonly SignInManager<ApplicationUser> signInManager;

        //public Tracker Tracker { get; set; }
        public JS_LetModel(ApplicationDbContext dbContext, SignInManager<ApplicationUser> signInManager)
        {
        ...
        public void OnGet()
        {
            if (signInManager.IsSignedIn(User))
            {
                ...
                if (getdata != null)
                {
                    getdata.WebUrl = "/Js-Page/JS-Let";
                }
                else
                {
                    Tracker tr = new()
                    {
                        WebUrl = "/Js-Page/JS-Let",
                        AppId = claim.Value
                    };
                    dbContext.Add(tr);
                }
